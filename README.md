...
Toda la salida de diseño se encuentra en la carpeta /dist, organizada por tecnología para que cada equipo use lo que necesite:

- /dist/css: Variables nativas de CSS para proyectos web estándar.

- /dist/scss: Variables para proyectos que utilicen Sass.

- /dist/json: Los datos puros en formato JSON. Ideal si usas herramientas como Style Dictionary para transformar estos tokens a otros formatos (Android, iOS, etc.).

- /dist/tailwind: Configuración lista para copiar en proyectos que usen Tailwind CSS.
...
Generación de archivos: Supernova traduce esos cambios a los archivos de código en la carpeta /dist.
...
No editar manualmente: Por favor, no modifiquen los archivos dentro de /dist. Cualquier cambio manual se perderá la próxima vez que yo actualice Figma.
